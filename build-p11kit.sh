...
P11KIT_TAR=p11-kit-0.23.12.tar.gz
...
"$WGET" --ca-certificate="$DIGICERT_ROOT" "https://github.com/p11-glue/p11-kit/releases/download/0.23.12/$P11KIT_TAR" -O "$P11KIT_TAR"
